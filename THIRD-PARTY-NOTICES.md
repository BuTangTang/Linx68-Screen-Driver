...
Linx68 Screen Driver is based on Keyboard Screen Studio and is licensed under the MIT License. Third-party components, fonts, services, names, and trademarks remain subject to their own terms.
