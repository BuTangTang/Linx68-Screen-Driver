...
| 时间与天气 | 翻页时钟、五日天气、时钟天气、城市晨报、今日节奏 |
| Codex 信息 | Codex 额度、Codex 任务（大字任务卡） |
| 音乐 | Windows 媒体会话、网易云封面回退与同步歌词 |

除此之外，应用还支持：

- 15 个适配竖屏小尺寸显示的内置主题，包括「磁带余晖」与「信号花园」
- 数据服务以绿色表示有效数据、红色表示空数据或错误，并展示来源、详情与耗时
- 天气支持 Windows 自动定位、手动回退和中文同名城市消歧，缓存不会跨城市回退
